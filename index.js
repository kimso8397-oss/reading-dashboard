...
const s = {
  ...
  statCard: { background: '#1a1a1a', borderRadius: 12, padding: '0.9rem 1rem' },
  statLabel: { fontSize: 11, color: '#666', margin: '0 0 6px' },
  statValue: { fontSize: 22, fontWeight: 600, color: '#eee', margin: '0 0 4px', lineHeight: 1.1, wordBreak: 'keep-all' },
